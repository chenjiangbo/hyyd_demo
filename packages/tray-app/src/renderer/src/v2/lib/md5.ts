/**
 * Standard RFC 1321 MD5 hash implementation in pure TypeScript.
...
export function md5(string: string): string {
  return rstr2hex(binl2rstr(binlMD5(rstr2binl(str2rstrUTF8(string)), str2rstrUTF8(string).length * 8)))
}
