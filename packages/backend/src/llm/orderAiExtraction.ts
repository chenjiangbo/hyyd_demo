...
// 套餐、初始意向等基础资料不在这里；若沟通明确说变更，才以 change_candidate 返回。
  ...
  { code: 'appointment_time', label: '预约就诊时间' },
  { code: 'appointment_success_time', label: '预约成功/预约反馈时间' },
  { code: 'service_start_time', label: '实际服务开始时间' },
  { code: 'latest_ticket_time', label: '最晚取号时间' },
  { code: 'registration_fee_amount', label: '挂号费金额', requiresConfirmation: true },
  { code: 'escort_name', label: '陪诊人员姓名' },
  { code: 'escort_phone', label: '陪诊联系电话' },
  { code: 'escort_service_date', label: '陪诊服务日期' },
  { code: 'escort_service_summary', label: '陪诊服务小结' },
